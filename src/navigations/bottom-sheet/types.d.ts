...
export interface BottomSheetNavigationEventMap {
  /**
...
export interface Layout { height: number; width: number }
...
export type BottomSheetDescriptorMap = Record<string, BottomSheetDescriptor>;
...
export interface BottomSheetCardInterpolationProps {
  /**
...
export interface BottomSheetCardInterpolatedStyle {
  /**
